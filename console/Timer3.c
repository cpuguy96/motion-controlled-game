...
void Timer3_Arm(void(*task)(void)){
  ...
  TIMER3_TAMR_R = 0x00000001;   // 3) configure for one shot mode
  TIMER3_TAILR_R = 16000000 - 1;   // 4) 1s reload value
...
/***************** Timer3A_Handler ****************
	Turns off timer and turns on PortE interrupts
	Inputs: none
	Outputs: none
*/
