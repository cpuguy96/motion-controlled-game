...
/***************** Timer1A_Handler ****************
	Outputs new wave index value to DAC
	Inputs: none
	Outputs: none
*/
...
/***************** Timer1_Reset_Per ****************
	Changes the frequency of NoteB
	Inputs: period - frequency of note converted to clock cycles
	Outputs: none
*/
void Timer1_Reset_Per(uint32_t period) {
